...
Advanced project room for reading stable social, cultural, symbolic, and spiritual forms as crystall objects.

This is not an entrypoint.
Read `stack-core` first.

The payload here is not human-facing explanation.
The payload is:
...
Use this room when ordinary prose carries too much human residue.
